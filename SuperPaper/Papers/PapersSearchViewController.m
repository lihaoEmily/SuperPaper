...
- (void)getData
{
    ...
    NSDictionary *parameters = @{@"type_id":self.typeId, @"keywords":_searchBar.text, @"start_pos":[NSNumber numberWithInt:(int)_responseArr.count], @"list_num":[NSNumber numberWithInt:SEARCHPAGESIZE]};
