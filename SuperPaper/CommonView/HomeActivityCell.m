...
- (void)creatUI{
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(LEFT_MARGIN * 2,LEFT_MARGIN * 4, SCREEN_WIDTH - LEFT_MARGIN * 4, 60)];
...
-(void)setInfoDict:(NSDictionary *)infoDict
{
    ...
    CGSize detailmaxSize = CGSizeMake(SCREEN_WIDTH - LEFT_MARGIN * 4, 60);
